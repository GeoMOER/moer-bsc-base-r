...
We will use Ilias mainly for the administration of the course, interaction during both synchronous and asynchronous phases, and for providing small static documents and data sharing.
...
You will use Ilias for uploading your assignments. We will discuss general issues which might have occured during the assignments in class. Individual feedback may be provided via Ilias, so please check that regularily. 
