...
The unmarked assignments are primarily for me to evaluate whether anyone is facing difficulties with the course material. I expect everyone to invest time and effort into completing these tasks (as outlined in the [expected workload](/moer-bsc-base-r/unit00/unit00-03_faq.html)), and all assignments should be submitted by Wednesday in the corresponding Ilias-folder.
